...
所有原始响应、WAV、torch trace 和环境记录保存在 PVC：

`<internal-evidence-path>`

主要文件：

- `candidate/host_result_same_process_0818c/analysis.json`
- `final_ab_stagefirst/c1/result.json`
- `final_ab_stage_second/c1/result.json`
- `final_ab_stagefirst/candidate_trace_c1/transfer_summary.json`
- `final_ab_stagefirst/baseline_trace_c1/transfer_summary.json`
- `final_ab_stage_second/{c4,c4_repeat,c8,c8_repeat}/result.json`
- `final_ab_stagefirst_reverse/{c4,c8,c8_repeat}/result.json`
- `final_baseline_compat_smoke/request/result.json`
